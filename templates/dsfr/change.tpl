...
{if $result !== "passwordchanged"}
    ...
    {/if}
        ...
        <div class="fr-password" style="padding-left: .5rem; padding-right: .5rem;"> <!--dsfr password with display toggle-->
            <label class="fr-password__label fr-label" for="oldpassword" class="fr-label">{$msg_oldpassword}</label>
            <div class="fr-input-wrap">
                <input class="fr-password__input fr-input" autocapitalize="off" autocorrect="off" aria-describedby="storybook-password-input-messages" aria-required="true" name="oldpassword" autocomplete="current-password" id="oldpassword" type="password">
            </div>
            <div class="fr-messages-group" id="storybook-password-input-messages" aria-live="polite">
            </div>
            <div class="fr-password__checkbox fr-checkbox-group fr-checkbox-group--sm">
                <input aria-label="Afficher le mot de passe" id="oldpassword-show" type="checkbox">
                <label class="fr--password__checkbox fr-label" for="oldpassword-show"> Afficher </label>
            </div>
        </div>
